                        ...
                        <#list specificationList as specification>
                            <dl>
                                ...
                                <#list specification.attributeValue as value>
                                    <dd><a href="javascript:;" class="{{isSelected('${specification.attributeName}','${value}')?'selected':''}}" ng-click="selectSpecifcation('${specification.attributeName}','${value}')">${value}<span title="点击取消选择">&nbsp;</span></a></dd>
                                </#list>
                            </dl>
                        </#list>
                    ...
                    <div class="tab-content tab-wraped">
                        ...
                        <div id="five" class="tab-pane">
                            <#list customAttributeList as attribute>
                                <p>${attribute.text}:${attribute.value}</p>
                            </#list>
                        </div>
                    </div>
                </div>
